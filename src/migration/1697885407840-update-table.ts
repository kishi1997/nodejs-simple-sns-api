...
export class UpdateTable1697885407840 implements MigrationInterface {
    name = 'UpdateTable1697885407840'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`user\` DROP FOREIGN KEY \`FK_63301650f99948e1ff5e0af00b5\``);
        await queryRunner.query(`DROP INDEX \`IDX_63301650f99948e1ff5e0af00b\` ON \`user\``);
        ...
        await queryRunner.query(`ALTER TABLE \`token\` ADD \`userId\` int NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_63301650f99948e1ff5e0af00b\` ON \`user\` (\`tokenId\`)`);
